<!--suppress HtmlUnknownAttribute, HtmlUnknownTag, XmlUnboundNsPrefix -->
...
- You must check existing Volt components to determine if they're functional or class based. If you can't detect that,
  ask the user which they prefer before writing a Volt component.

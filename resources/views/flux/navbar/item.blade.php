...
//    ])
    ->add(match ($accent) {
        true => [
            ...
            'data-current:text-(--color-accent-content) hover:data-current:text-(--color-accent-content) hover:text-(--color-accent-content) ', //hover:bg-zinc-800/5 dark:hover:bg-white/10 hover:data-current:bg-(--hover-fill)

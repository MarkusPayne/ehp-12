...
$classes = Flux::classes()
    ->add('h-10 lg:h-8 relative flex items-center gap-3 rounded-xs')
    ->add($square ? 'px-2.5!' : '')
    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                ...
                'data-current:underline data-current:underline-offset-4',//dark:data-current:bg-white/[7%] data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
